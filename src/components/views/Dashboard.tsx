...
export function Dashboard({ t, setRoute }: DashboardProps) {
  const [tasksDone, setTasksDone] = useState({ 2: false, 3: false });
  ...
  const activity = [
    { photo: PROPERTY_PHOTOS[0], title: 'Penthouse con vista al mar — compartida con Diego F.', meta: 'Cap Cana · $485,000', time: 'hace 12m' },
    { photo: PROPERTY_PHOTOS[2], title: 'Villa con piscina infinita — nueva visita programada', meta: 'Casa de Campo · $610,000', time: 'hace 1h' },
    { photo: PROPERTY_PHOTOS[4], title: 'Penthouse Anacaona — brochure enviado a Lucía M.', meta: 'Anacaona · $890,000', time: 'hace 3h' },
    { photo: PROPERTY_PHOTOS[1], title: 'Torre Vista Real — publicada en portal externo', meta: 'Piantini · $320,000', time: 'hace 5h' },
  ];
